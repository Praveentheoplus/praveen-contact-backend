...
app.use(cors({
  origin: '*', // In production, replace with your actual portfolio URL
  methods: ['POST', 'GET'],
}));
        ...
        <div class="wrapper">
          <div class="card">
            <div class="header">
              ...
              <p>Received via praveent.dev contact form</p>
            </div>
            <div class="body">
              <div class="field">
            ...
            <div class="footer">
              <p>This email was sent from your portfolio contact form. Reply-To is set to the sender's email.</p>
            </div>
          </div>
        </div>
      </body>
